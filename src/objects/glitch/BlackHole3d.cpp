...
#include "bn_sprite_items_glitch_blackhole.h"

#define SCALE_OUT_SPEED 0.15

BlackHole3d::BlackHole3d(int _channel,
                         ...
                         Event* _event)
    : sprite(
          bn::sprite_items::glitch_blackhole.create_sprite(_initialPosition)),
      ...
      animation(bn::create_sprite_animate_action_forever(
          sprite,
          2,
          bn::sprite_items::glitch_blackhole.tiles_item(),
          0,
          1,
          2,
          3,
...
void BlackHole3d::explode(bn::fixed_point nextTarget) {
  isExploding = true;
}
