...
#include "bn_sprite_items_glitch_minifireball.h"

#define SCALE_OUT_SPEED 0.15

FireBall3d::FireBall3d(int _channel,
                       ...
                       bn::fixed _frames,
                       Event* _event)
    : sprite(bn::sprite_items::glitch_minifireball.create_sprite(
          _initialPosition)),
      ...
      animation(bn::create_sprite_animate_action_forever(
          sprite,
          3,
          bn::sprite_items::glitch_minifireball.tiles_item(),
          0,
          1,
          2)) {
  channel = _channel;
...
bool FireBall3d::update(int msecs,
                        bool isInsideBeat,
...
void FireBall3d::explode(bn::fixed_point nextTarget) {
  isExploding = true;
}
