...
Lightning::Lightning(bn::fixed_point _topLeftPosition, Event* _event)
    : TopLeftGameObject(
      ...
      sprite2(bn::sprite_items::wizard_lightning11.create_sprite(0, 0)),
      sprite3(bn::sprite_items::wizard_lightning2.create_sprite(0, 0)),
      sprite4(bn::sprite_items::wizard_lightning22.create_sprite(0, 0)),
      sprite5(bn::sprite_items::wizard_lightning3.create_sprite(0, 0)),
      event(_event) {
...
bool Lightning::update(int msecs) {
  if (msecs < event->timestamp) {
    ...
    animation1 = bn::create_sprite_animate_action_forever(
        ...
        HINT_OFFSET + 0, HINT_OFFSET + 1, HINT_OFFSET + 0, HINT_OFFSET + 1,
        HINT_OFFSET + 3, HINT_OFFSET + 1, HINT_OFFSET + 3, HINT_OFFSET + 1);
    animation2 = bn::create_sprite_animate_action_forever(
        sprite2, 2, bn::sprite_items::wizard_lightning11.tiles_item(),
        HINT_OFFSET + 0, HINT_OFFSET + 1, HINT_OFFSET + 0, HINT_OFFSET + 1,
        HINT_OFFSET + 3, HINT_OFFSET + 1, HINT_OFFSET + 3, HINT_OFFSET + 1),
    animation3 = bn::create_sprite_animate_action_forever(
        sprite3, 2, bn::sprite_items::wizard_lightning2.tiles_item(),
        HINT_OFFSET + 0, HINT_OFFSET + 1, HINT_OFFSET + 0, HINT_OFFSET + 1,
        HINT_OFFSET + 3, HINT_OFFSET + 1, HINT_OFFSET + 3, HINT_OFFSET + 1);
    animation4 = bn::create_sprite_animate_action_forever(
        sprite4, 2, bn::sprite_items::wizard_lightning22.tiles_item(),
        HINT_OFFSET + 0, HINT_OFFSET + 1, HINT_OFFSET + 0, HINT_OFFSET + 1,
        HINT_OFFSET + 3, HINT_OFFSET + 1, HINT_OFFSET + 3, HINT_OFFSET + 1);
    animation5 = bn::create_sprite_animate_action_forever(
        sprite5, 2, bn::sprite_items::wizard_lightning3.tiles_item(),
        HINT_OFFSET + 0, HINT_OFFSET + 1, HINT_OFFSET + 0, HINT_OFFSET + 1,
        HINT_OFFSET + 3, HINT_OFFSET + 1, HINT_OFFSET + 3, HINT_OFFSET + 1);
  }
...
void Lightning::start2() {
  animation1 = bn::create_sprite_animate_action_once(
      mainSprite, 2, bn::sprite_items::wizard_lightning1.tiles_item(), 0, 1, 0,
      1, 3, 1, 3, 1);
  animation2 = bn::create_sprite_animate_action_once(
      sprite2, 2, bn::sprite_items::wizard_lightning11.tiles_item(), 0, 1, 0, 1,
      3, 1, 3, 1);
  animation3 = bn::create_sprite_animate_action_once(
      sprite3, 2, bn::sprite_items::wizard_lightning2.tiles_item(), 0, 1, 0, 1,
      3, 1, 3, 1);
  animation4 = bn::create_sprite_animate_action_once(
      sprite4, 2, bn::sprite_items::wizard_lightning22.tiles_item(), 0, 1, 0, 1,
      3, 1, 3, 1);
  animation5 = bn::create_sprite_animate_action_once(
      sprite5, 2, bn::sprite_items::wizard_lightning3.tiles_item(), 0, 1, 0, 1,
      3, 1, 3, 1);
